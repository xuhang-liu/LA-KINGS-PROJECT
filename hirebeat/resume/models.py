...
class Resume(models.Model):
    ...
    ats_findings_count_total = models.CharField(max_length=50, null=True, blank=True)
    rec_findings_count = models.CharField(max_length=50, null=True, blank=True)
    rec_findings_count_total = models.CharField(max_length=50, null=True, blank=True)
    skills_match_count = models.CharField(max_length=50, null=True, blank=True)
    skills_match_count_total = models.CharField(max_length=50, null=True, blank=True)
