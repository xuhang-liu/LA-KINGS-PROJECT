...
from .views import add_new_job, get_all_jobs, update_job, archive_job, add_new_apply_candidate, get_current_jobs, \
    ...
    add_new_apply_candidate_from_zr, getCompanyBrandingInfo, get_resume_from_job_application, create_merge_link_token, \
    retrive_merge_account_token, send_merge_api_request, check_free_account_active_jobs
