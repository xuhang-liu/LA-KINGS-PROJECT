...
from .views import add_new_job, get_all_jobs, update_job, archive_job, add_new_apply_candidate, get_current_jobs, \
    ...
    job_target_job_id_update, add_new_apply_candidate_from_jobtarget, job_target_push_candidates_back, get_most_recent_jobs
...
urlpatterns = [
    ...
    path('jobs/add-new-apply-candidate-from-jobtarget', add_new_apply_candidate_from_jobtarget),
