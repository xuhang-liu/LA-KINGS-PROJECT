    ...
    <div className="container-fluid row">
      ...
      <div className="col-xl-8 col-lg-12 col-md-12 col-sm-12 py-4 px-5">
        ...
        <form id="payment-form" onSubmit={handleSubmit}>
          ...
          <div className="row">
            <div className="col-4">
              <p>{(props.price == 399) ? "Monthly " : "Annual "}Premium Subtotal</p>
            </div>
            <div className="col-1"></div>
            <div className="col-3"><p>${(props.price == 399) ? "399" : "3,588"}{(props.price == 399) ? " / mo" : " / yr"}</p></div>
          </div>
          ...
          <div className="row">
            ...
            <div className="col-1"></div>
            {(percent == 1) ?
              <div className="col-3"><p>${(props.price == 399) ? "399" : "3,588"}</p></div> :
              <div className="col-3"><p style={{ display: "inline-block" }}>${(props.price == 399) ? (399 * percent)?.toLocaleString(undefined, {maximumFractionDigits:2}) : (3588 * percent)?.toLocaleString(undefined, {maximumFractionDigits:2})}</p><p style={{ marginLeft: "0.6rem", color: "#7a7a7a", textDecorationLine: "line-through", display: "inline-block" }}>${(props.price == 399) ? "399" : "3588"}</p></div>
            }
          </div>
