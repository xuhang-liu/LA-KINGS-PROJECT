...
class AIGInfo extends Component {
    render() {
        return (
            <React.Fragment>
                <Helmet>
                    ...
                    <link rel="canonical" href="https://hirebeat.co/companydata/american-international-group"/>
                </Helmet>
                <ScrollToTopOnMount />
                <PageTitleArea 
                    pageTitle="American International Group"
