...
export default function AIGIQ(props){
    ...
    return(
        <div style={{marginTop: '5%'}}>
            ...
            <div>
                  <p className="companydata-text2"><li>Tell us a time when you have showed team work?</li></p>
                  <p className="companydata-text2"><li>Tell me about a time you showed leadership.</li></p>
                  <p className="companydata-text2"><li>Tell us a time you overcame adversity.</li></p>
                  <p className="companydata-text2"><li>Have you worked in a job where you’re performance is monitored/measured?</li></p>
                  <p className="companydata-text2"><li>What do you think of the accident and health industry?</li></p>
                  <p className="companydata-text2"><li>describe a time when you made a mistake and had to admit to it?</li></p>
                  <p className="companydata-text2"><li>Describe a time where managed to complete multiple tasks by a deadline.</li></p>
            </div>
