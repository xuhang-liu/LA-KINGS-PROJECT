...
export default function MUFGIQ(props){
    ...
    return(
        <div style={{marginTop: '5%'}}>
            ...
            <div>
                  <p className="companydata-text2"><li>What is your most proud achievement？</li></p>
                  <p className="companydata-text2"><li>Where do you see your self in 5 years？</li></p>
                  <p className="companydata-text2"><li>What do you know about debt markets?</li></p>
                  <p className="companydata-text2"><li>What are your strengths and weaknesses?</li></p>
                  <p className="companydata-text2"><li>What quality do you think your manager should possess.</li></p>
                  <p className="companydata-text2"><li>Name a time you had to work with someone who doesn't have the same work ethic as you?</li></p>
                  <p className="companydata-text2"><li>What were your experiences and how to cope up with stress?</li></p>
            </div>
