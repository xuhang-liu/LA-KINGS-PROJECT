...
export default function NDQIQ(props){
    ...
    return(
        <div style={{marginTop: '5%'}}>
            ...
            <div>
                  <p className="companydata-text2"><li>How will you deal with stress?</li></p>
                  <p className="companydata-text2"><li>Why are you interested in Nasdaq?</li></p>
                  <p className="companydata-text2"><li>What are your strengths/Why would you be a good fit for this position?</li></p>
                  <p className="companydata-text2"><li>What specific experience do you have related to this job?</li></p>
                  <p className="companydata-text2"><li>Give an example of when you worked with a team. What were some challenges you faced?</li></p>
                  <p className="companydata-text2"><li>What do you do in your spare time?</li></p>
                  <p className="companydata-text2"><li>What is something that you have either created or want to create?</li></p>
            </div>
