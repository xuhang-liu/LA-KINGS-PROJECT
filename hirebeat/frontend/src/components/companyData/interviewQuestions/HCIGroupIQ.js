...
export default function HCIGroupIQ(props){
...
function renderContent(filter)  {
    switch (filter) {
        default: case "Q1":
            return(
                <div>
                    <p className="companydata-text2"><li>Tell me about your post-secondary experience and how it prepared you for a career with HCI Group?</li></p>
                    ...
                    <p className="companydata-text2"><li>At HCI Group we prefer to hire individuals with longevity in mind. Where do you see your career 5 years from now?</li></p>
        ...
        case "Q2":
            return(
                <div>
                    ...
                    <p className="companydata-text2"><li>Within HCI Group many of our positions require a Bachelor's or Master's Degree. Have you considered furthering your education in order to advance your career?</li></p>
        ...
        case "Q3":
            return(
                <div>
                    ...
                    <p className="companydata-text2"><li>Tell me about an error or mistake you made because of a breakdown in communication between you or one of your team members.</li></p>
                    <p className="companydata-text2"><li>What do you know about the culture at HCI Group?</li></p>
