...
import EmailUnsubscribe from "./Email/EmailUnsubscribe";
            ...
            <PersistGate loading={null} persistor={persistor}>
              <AlertProvider template={AlertTemplate} {...alertOptions}>
                ...
                <Route exact path="/employer_blog-five-ways-applicant-tracking-systems-up" component={BlogDetail27_Employer} /> */}
                      ...
                      <Route exact path="/unsubscribed" component={EmailUnsubscribe} />
                      <Route exact path="/not-unsubscribed" component={EmailUnsubscribe} />
