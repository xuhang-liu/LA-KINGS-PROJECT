...
class PJobFail extends Component {
    componentDidMount() {
        this.renderRedirect();
    }
                    ...
                    return (
                        <div>
                            ...
                            <div className="container py-5 px-5" style={{ fontFamily: "Inter, Segoe UI", backgroundColor: "#ffffff", borderRadius: "10px", boxShadow: "2px 2px 4px rgba(128, 128, 128, 0.16)" }}>
                                <h3 className="profile-p" style={{ textAlign: "center", marginBottom: "2rem", marginTop: "1rem" }}>Oops! Looks like the payment was not successful.</h3>
                                <h3 className="profile-p" style={{ textAlign: "center", marginBottom: "2rem", marginTop: "1rem" }}>No worries!</h3>
                                <h3 className="profile-p" style={{ textAlign: "center", marginBottom: "2rem", marginTop: "1rem" }}>Your job is published on Hirebeat network and will</h3>
                                <h3 className="profile-p" style={{ textAlign: "center", marginBottom: "2rem", marginTop: "-1rem" }}>also appear on other free job boards within 24 hours.</h3>
                                <h3 className="profile-p" style={{ textAlign: "center", marginBottom: "2rem", marginTop: "1rem" }}>You can always go back and upgrade to</h3>
                                <h3 className="profile-p" style={{ textAlign: "center", marginBottom: "2rem", marginTop: "-1rem" }}>Premium Advertising by editing the job.</h3>
                                <div className="row ml-2 mb-5" style={{ position: "relative", background: "#F4F5FD", borderRadius: "5px", border: "1px solid #006dff", width: "90%", height: "4rem" }}>
