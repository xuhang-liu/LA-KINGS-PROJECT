...
import { searchJobseekerJobs } from "../../redux/actions/auth_actions";


export class MyJobFilter extends Component {
...
export default connect(mapStateToProps, { searchJobseekerJobs })(
    MyJobFilter
);