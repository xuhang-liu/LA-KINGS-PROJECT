                ...
                <React.Fragment>
                    ...
                    <ReactWOW>
                        <div className="overview-item pt-100 pb-70" style={{ backgroundColor: "#f4f5fd", marginBottom: "0" }}>
                            ...
                            <MediaQuery minDeviceWidth={1224}>
                            <a href="/employer-pricing" className="default-btn" style={{paddingLeft:"25px", backgroundColor:"#ff6b00", color:"#ffffff", textDecoration:"none", top:"6rem", left:"42%"}}>Become an Integrations Partner</a>
                            </MediaQuery>
                            <MediaQuery maxDeviceWidth={1223}>
                            <a href="/employer-pricing" className="default-btn" style={{paddingLeft:"25px", backgroundColor:"#ff6b00", color:"#ffffff", textDecoration:"none", top:"3rem", left:"20%"}}>Become an Integrations Partner</a>
                            </MediaQuery>
                        </div>
                    </ReactWOW>
