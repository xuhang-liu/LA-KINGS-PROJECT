            ...
            <div className="container" style={{width:'95%'}}>
                ...
                {this.props.dataLoaded ?
                    (this.props.isRecorded ?
                        ...
                        <div className="card container justify-items" style={{marginTop:"10%", marginBottom: "10%"}}>
                            <p className="interview-txt9" style={{textAlign: "center"}}>
                                The Candidate Haven't Finished The Interviews Yet
                            </p>
                        </div>)
                    : null
                }
