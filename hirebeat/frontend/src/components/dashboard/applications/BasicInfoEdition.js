    ...
    render() {
        return (
            <Box bg="bg-surface" borderRadius="md" boxShadow="sm" p='4'>
                <Box mb='4'>
                    <Heading as='h3' size='xs' wordWrap='break-word' wordBreak='break-word'>{this.props.first_name + " " + this.props.last_name}</Heading>
                </Box>
                ...
                <div className="mb-2" style={{ marginTop: "1%", display: "flex", alignItems: "center", marginBottom: "1vw", fontSize: "0.8vw" }}>
                ...
                <div className="d-flex justify-content-between" style={{ marginTop: "1vw", marginBottom: "0.6rem" }}>
                    <Button borderRadius='sm' colorScheme='blue' size='sm' onClick={this.saveUpdate}>Save</Button>
                    <Button borderRadius='sm' colorScheme='gray' size='sm' onClick={() => this.props.setIsEdit(false)}>Cancel</Button>
                </div>
            </Box>
        )
    }
