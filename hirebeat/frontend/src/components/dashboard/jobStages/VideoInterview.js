...
import { Applicant } from "./interviewComponents/Applicant";
import 'boxicons';
                                ...
                                <HStack spacing='3'>
                                    ...
                                    <Box>
                                        {(props.reviewerStageLength == 0) &&
                                            ...
                                            >
                                                <i className="bx-fw bx bx-info-circle pr-1"></i> Edit Questions
                                            </Button>
                                        }
                                    </Box>
                                    <Box>
                                        <Button
                                            ...
                                            colorScheme='gray' variant='ghost'
                                        >
                                            <i style={{ color: "#006dff" }} className="bx-fw bx bx-bullseye pr-1"></i> Preview Email
                                        </Button>
                                    </Box>
                                </HStack>
                            </Box>
                                ...
                                <Table>
                                    <Thead>
                                        <Tr>
                                            ...
                                            <Th><Text color="muted">Invited On</Text></Th>
                                            <Th>
