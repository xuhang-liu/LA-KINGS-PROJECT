        ...
        return (
            <>
                ...
                <div className="mb-4 pl-0" style={{ marginLeft: "-2rem" }}>
                    <div className="mt-3">
                        <h4>
                            <Text color='muted' style={{ fontWeight: "600" }}>Question: <span style={{ fontWeight: "500" }}>{this.props.question}</span></Text>
                        </h4>
                    </div>
                    <div className="row">
                        <div className="col-7">
                            ...
                            <div className="row mt-3 ml-1">
                                <div className="col-3">
                                    <Text color='muted' style={{ fontWeight: "600" }}>Speed</Text>
                                </div>
                                <div className="col-9">
                        ...
                        {!this.props.profile.is_external_reviewer &&
                            <div className='col'>
                                <div className="row mt-3 px-4">
                                    <div style={{ width: "100%" }}>
                                        <Text color='muted' style={{ fontWeight: "500" }}>Transcript</Text>
