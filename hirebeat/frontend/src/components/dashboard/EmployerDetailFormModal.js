...
export class EmployerDetailFormModal extends Component {
  ...
  setCloseWelcome = () => {
    ...
    this.setState({ isOpenEmployerDetail: true });
  };

  closeEmployerDetail = () => {
    this.setState({ isOpenEmployerDetail: false });
  };
  ...
  onSubmit = () => {
    ...
    let data1 = {
      ...
      location: location,
      company_size:
        this.state.companySize.value == null ||
        this.state.companySize.value == ""
          ? this.props.employerProfileDetail.company_size
          : this.state.companySize.value,
    };
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <MyModalUpgrade
          show={this.state.isOpenEmployerDetail}
          onHide={this.closeEmployerDetail}
          backdrop="static"
        >
          <div style={{ backgroundColor: "#5772f0" }}>
            ...
            >
              <div>
                ...
                >
                  <div
                    className="detailform_part1_left"
