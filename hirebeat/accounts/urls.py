...
from .views import sign_s3_upload, ActivateAccount, upgrade_accounts, \
    ...
    update_employer_onboard0, create_or_update_employer_tutorial_infos, job_target_info_update, stripe_create_subcription, stripe_apply_coupon_code, stripe_cancel_subcription
...
urlpatterns = [
    ...
    path("accounts/stripe-cancel-subscription", csrf_exempt(stripe_cancel_subcription), name="stripe apply coupon code")
]
