...
from .views import sign_s3_upload, ActivateAccount, upgrade_accounts, \
    ...
    update_employer_onboard0, create_or_update_employer_tutorial_infos, stripe_paymentIntent
...
urlpatterns = [
    ...
    path("accounts/stripe-paymentIntent", csrf_exempt(stripe_paymentIntent), name="stripe paymentIntent")
]
